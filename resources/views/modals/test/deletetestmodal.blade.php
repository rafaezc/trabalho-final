<form action="{{ route('tests.destroy') }}" method="post">
    <div class="modal fade" id="{{ $modal_id1 }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalLabel">{{ $modal_title1 }}</h5>
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="delete-warning">
                            <div id="delete-testname-warning">Confirma a exlusão do teste ?</div>    
